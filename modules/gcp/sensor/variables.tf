...
variable "zones" {
  type        = list(string)
  default     = []
  description = "List of zones within the region to distribute sensors across. If empty, sensors will be distributed across all available zones in the region."
}
