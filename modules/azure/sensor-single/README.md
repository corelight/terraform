...
| <a name="input_egress_allow_cidrs"></a> [egress\_allow\_cidrs](#input\_egress\_allow\_cidrs) | The IP ranges allowed outbound for both NICs. Typically can be left as default. | `list(string)` | <pre>["0.0.0.0/0"]</pre> | no |
...
| <a name="input_health_check_allow_cidrs"></a> [health\_check\_allow\_cidrs](#input\_health\_check\_allow\_cidrs) | CIDRs allowed to health check the sensor (port 41080) | `list(string)` | <pre>["0.0.0.0/0"]</pre> | no |
...
| <a name="input_monitoring_ingress_allow_cidrs"></a> [monitoring\_ingress\_allow\_cidrs](#input\_monitoring\_ingress\_allow\_cidrs) | CIDRs allowed to send mirrored traffic (VXLAN 4789) to the monitoring NIC | `list(string)` | <pre>["0.0.0.0/0"]</pre> | no |
