...
variable "management_interface_name" {
  description = "The name of the management interface for the sensor (defaults to <deployment_name>-mgmt-nic)"
  type        = string
  default     = null
}
...
variable "monitoring_interface_name" {
  description = "The name of the monitoring interface for the sensor (defaults to <deployment_name>-mon-nic)"
  type        = string
  default     = null
}
...
variable "monitoring_security_group_name" {
  description = "Name of the security group the module will provision for the monitoring ENI (defaults to <deployment_name>-mon-sg)"
  type        = string
  default     = null
}
...
variable "management_security_group_name" {
  description = "Name of the security group the module will provision for the management ENI (defaults to <deployment_name>-mgmt-sg)"
  type        = string
  default     = null
}
...
variable "instance_name" {
  description = "The name for the sensor EC2 instance (defaults to <deployment_name>-sensor)"
  type        = string
  default     = null
}
