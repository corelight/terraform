...
resource "aws_security_group" "monitoring_sg" {
  ...
  name        = var.monitoring_security_group_name != null ? var.monitoring_security_group_name : "${var.deployment_name}-mon-sg"
...
resource "aws_security_group" "management_sg" {
  ...
  name        = var.management_security_group_name != null ? var.management_security_group_name : "${var.deployment_name}-mgmt-sg"
...
module "management_interface" {
  ...
  source = "./submodules/network_interface"

  associate_public_ip_address = var.management_interface_public_ip
  interface_name              = var.management_interface_name != null ? var.management_interface_name : "${var.deployment_name}-mgmt-nic"
...
module "monitoring_interface" {
  ...
  interface_name              = var.monitoring_interface_name != null ? var.monitoring_interface_name : "${var.deployment_name}-mon-nic"
...
module "instance" {
  ...
  instance_name             = var.instance_name != null ? var.instance_name : "${var.deployment_name}-sensor"
